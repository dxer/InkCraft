...
- **高价值知识卡片 (`/cards`)** —— 内容入库后 AI 自动萃取为一张「能出货」的六维原子知识卡片：
  - **核心洞察**（直击本质的底层判断，拒绝平淡陈述）
  - **认知张力**（90%的人常犯的惯性误区 vs 破局逻辑）
  - **边界与约束**（适用情境与踩坑警示）
  - **硬核零件**（关键论据/数据/生动隐喻 + 原文短引）
  - **破题切口**（抓人眼球的首句破题金句或设问）
  - **截图级金句**（最具穿透力、适合截图保存的金句）
  - 支持在卡片详情中一键**「选择技能去创作 ▾」**直达工坊成稿
